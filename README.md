# John Lewis Price Tracker

[![Bright Data](https://img.shields.io/badge/Powered%20by-Bright%20Data-blue?style=flat-square)](https://brightdata.de)
[![John Lewis Price Tracker](https://img.shields.io/badge/John%20Lewis%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/john-lewis)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/john-lewis)

John Lewis-Preisverfolgung in Echtzeit – eine gehobene britische Kaufhauskette. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit dem AI Scraper Builder von Bright Data.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/john-lewis)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **John Lewis-Preise überwachen** über alle Produktkategorien hinweg
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/john-lewis)**

---

## Option 2: Erstellen Sie Ihren eigenen John Lewis Scraper

Keine vorgefertigte John Lewis Scraper API? Kein Problem. Der **AI Scraper Builder** von Bright Data generiert mit nur wenigen Klicks einen benutzerdefinierten John Lewis Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren John Lewis Scraper in wenigen Minuten

**[Öffnen Sie den John Lewis AI Scraper Builder →](https://brightdata.de/products/web-scraper/john-lewis)**
...
- Eine **Web Scraper ID** für John Lewis (aus dem obigen Build-Schritt)
...
1. **Dieses repository klonen**
   ...
   ```bash
   git clone https://github.com/bright-data-de/john-lewis-price-tracker.git
   cd john-lewis-price-tracker
   ```
...
3. **Zugangsdaten konfigurieren**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder-Dashboard](https://brightdata.de/products/web-scraper/john-lewis)
...
Sobald Ihr John Lewis Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von John Lewis-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.johnlewis.com/product/sample-item-123456",
...
Sammeln Sie alle Produkte von einer John Lewis-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://johnlewis.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.johnlewis.com/product/sample-item-123456",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://johnlewis.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.johnlewis.com/product/sample-item-123456"}]
...
- 🌟 [John Lewis Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/john-lewis)
- 🏗️ [Build a John Lewis Scraper](https://brightdata.de/products/web-scraper/john-lewis)
